                            ...
                            @if ($cartItem->product)
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">${{ $cartItem->product->price * $cartItem->quantity }}</label>
                                            @php
                                        ...
                                        <div class="col-md-2 col-5 my-auto">
                                            <div class="remove">
                                                <button type="button" wire:loading.attr="disabled" wire:click="remoteCartItem({{ $cartItem->id }})" class="btn btn-danger btn-sm">
                                                   <span wire:loading.remove wire:target="remoteCartItem({{ $cartItem->id }})">
                                                        <i class="fa fa-trash"></i> Remove
                                                   </span>
                                                   <span wire:loading wire:target="remoteCartItem({{ $cartItem->id }})">
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h4>
                        ...
                        <a href="{{ url('collections') }}" style="text-decoration: none; color: var(--primary-color)">Shop now</a>
                    </h4>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>
                            Total: <span class="float-end">{{ $totalPrice }}$</span>
                        </h4>
                        <hr>
                        <a href="{{ url('/checkout') }}" class="btn btn-warning w-100">Check</a>
                    </div>
                </div>
            </div>
        </div>
